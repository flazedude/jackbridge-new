...
struct ContentView: View {
    ...
    private var filteredConnections: [JackBridgeViewModel.ConnectionLog] {
    ...
    private var filteredActivityLogs: [JackBridgeViewModel.ActivityLog] {
...
struct ConnectionsView: View {
    let connections: [JackBridgeViewModel.ConnectionLog]
    ...
    private func connectionRow(_ connection: JackBridgeViewModel.ConnectionLog) -> some View {
        HStack(spacing: 12) {
...
struct ActivityLogsView: View {
    let logs: [JackBridgeViewModel.ActivityLog]
    @Binding var searchText: String
    let onClear: () -> Void
    ...
    private func logRow(_ log: JackBridgeViewModel.ActivityLog) -> some View {
        HStack(spacing: 12) {
